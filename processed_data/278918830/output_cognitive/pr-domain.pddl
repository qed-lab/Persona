(define
	...
	(:predicates
		...
		(EXPLAINED_DROP_ARTHUR_HAIRTONIC_VALLEY_1)
		(EXPLAINED_PICKUP_ARTHUR_HAIRTONIC_VALLEY_1)
		...
		(NOT_EXPLAINED_DROP_ARTHUR_HAIRTONIC_VALLEY_1)
		(NOT_EXPLAINED_PICKUP_ARTHUR_HAIRTONIC_VALLEY_1)
	...
	(:action EXPLAIN_OBS_DROP_ARTHUR_HAIRTONIC_VALLEY_1
		:parameters ()
		:precondition
		(and
			(WILLING-TO-GIVE-ITEM_ARTHUR_HAIRTONIC)
		...
		(and
			...
			(not (WILLING-TO-GIVE-ITEM_ARTHUR_HAIRTONIC))
			 (not (NOT_EXPLAINED_DROP_ARTHUR_HAIRTONIC_VALLEY_1))
		)
	)
	...
	(:action EXPLAIN_OBS_PICKUP_ARTHUR_HAIRTONIC_VALLEY_1
		:parameters ()
		:precondition
		(and
			(AT_HAIRTONIC_VALLEY)
		...
		(and
			...
			(not (AT_HAIRTONIC_VALLEY))
			(not (NOT-HAS_ARTHUR_HAIRTONIC))
			 (not (NOT_EXPLAINED_PICKUP_ARTHUR_HAIRTONIC_VALLEY_1))
		)
	)
