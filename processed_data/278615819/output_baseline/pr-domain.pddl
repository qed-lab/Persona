(define
	...
	(:predicates
		...
		(EXPLAINED_MOVE-THROUGH-ENTRANCE_ARTHUR_BAR_BAREXIT_DOCKS_3)
	...
	(:action EXPLAIN_OBS_MOVE-THROUGH-ENTRANCE_ARTHUR_BAR_BAREXIT_DOCKS_3
		:parameters ()
		:precondition
		(and
			(NOT-CLOSED_BAREXIT)
		...
		(and
			...
			(not (AT_ARTHUR_BAR))
			(not (NOT-AT_ARTHUR_DOCKS))
			 (not (NOT_EXPLAINED_MOVE-THROUGH-ENTRANCE_ARTHUR_BAR_BAREXIT_DOCKS_3))
		)
	)
	(:action MOVE-THROUGH-ENTRANCE_ARTHUR_BAR_BAREXIT_DOCKS
		:parameters ()
