(define
	...
	(:predicates
		...
		(EXPLAINED_DROP_ARTHUR_BOOK_DOCKS_1)
		...
		(NOT_EXPLAINED_DROP_ARTHUR_BOOK_DOCKS_1)
	...
	(:action EXPLAIN_OBS_DROP_ARTHUR_BOOK_DOCKS_1
		:parameters ()
		:precondition
		(and
			(WILLING-TO-GIVE-ITEM_ARTHUR_BOOK)
		...
		(and
			...
			(not (WILLING-TO-GIVE-ITEM_ARTHUR_BOOK))
			 (not (NOT_EXPLAINED_DROP_ARTHUR_BOOK_DOCKS_1))
		)
	)
