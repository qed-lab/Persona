(define
	...
	(:predicates
		...
		(EXPLAINED_DROP_ARTHUR_ROPE_DOCKS_1)
		...
		(EXPLAINED_PICKUP_ARTHUR_MIRROR_TOWNARCH_1)
		...
		(NOT_EXPLAINED_DROP_ARTHUR_ROPE_DOCKS_1)
		...
		(NOT_EXPLAINED_PICKUP_ARTHUR_MIRROR_TOWNARCH_1)
	...
	(:action EXPLAIN_OBS_DROP_ARTHUR_ROPE_DOCKS_1
		:parameters ()
		:precondition
		(and
			(WILLING-TO-GIVE-ITEM_ARTHUR_ROPE)
		...
		(and
			...
			(not (WILLING-TO-GIVE-ITEM_ARTHUR_ROPE))
			 (not (NOT_EXPLAINED_DROP_ARTHUR_ROPE_DOCKS_1))
		)
	)
	...
	(:action EXPLAIN_OBS_PICKUP_ARTHUR_MIRROR_TOWNARCH_1
		:parameters ()
		:precondition
		(and
			(AT_MIRROR_TOWNARCH)
		...
		(and
			...
			(not (NOT-HAS_ARTHUR_MIRROR))
			 (not (NOT_EXPLAINED_PICKUP_ARTHUR_MIRROR_TOWNARCH_1))
		)
	)
