(define
	...
	(:predicates
		...
		(EXPLAINED_PICKUP_ARTHUR_SILVER_TOWNSQUARE_1)
		...
		(NOT_EXPLAINED_PICKUP_ARTHUR_SILVER_TOWNSQUARE_1)
	...
	(:action EXPLAIN_OBS_PICKUP_ARTHUR_SILVER_TOWNSQUARE_1
		:parameters ()
		:precondition
		(and
			(AT_SILVER_TOWNSQUARE)
		...
		(and
			...
			(not (NOT-HAS_ARTHUR_SILVER))
			 (not (NOT_EXPLAINED_PICKUP_ARTHUR_SILVER_TOWNSQUARE_1))
		)
	)
