(define
	...
	(:predicates
		...
		(EXPLAINED_MOVE-THROUGH-ENTRANCE_ARTHUR_TOWNSQUARE_SHOPENTRANCE_SHOP_5)
		...
		(NOT_EXPLAINED_MOVE-THROUGH-ENTRANCE_ARTHUR_TOWNSQUARE_SHOPENTRANCE_SHOP_5)
	...
	(:action EXPLAIN_OBS_MOVE-THROUGH-ENTRANCE_ARTHUR_TOWNSQUARE_SHOPENTRANCE_SHOP_5
		:parameters ()
		:precondition
		(and
			(NOT-CLOSED_SHOPENTRANCE)
		...
		(and
			...
			(not (AT_ARTHUR_TOWNSQUARE))
			(not (NOT-AT_ARTHUR_SHOP))
			 (not (NOT_EXPLAINED_MOVE-THROUGH-ENTRANCE_ARTHUR_TOWNSQUARE_SHOPENTRANCE_SHOP_5))
