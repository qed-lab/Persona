(define
	...
	(:predicates
		...
		(EXPLAINED_MOVE-THROUGH-ENTRANCE_ARTHUR_DOCKS_BARENTRANCE_BAR_2)
	...
	(:action EXPLAIN_OBS_MOVE-THROUGH-ENTRANCE_ARTHUR_DOCKS_BARENTRANCE_BAR_2
		:parameters ()
		:precondition
		(and
			(NOT-CLOSED_BARENTRANCE)
		...
		(and
			...
			(not (AT_ARTHUR_DOCKS))
			(not (NOT-AT_ARTHUR_BAR))
			 (not (NOT_EXPLAINED_MOVE-THROUGH-ENTRANCE_ARTHUR_DOCKS_BARENTRANCE_BAR_2))
		)
	)
