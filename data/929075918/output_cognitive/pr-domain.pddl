(define
	...
	(:predicates
		...
		(EXPLAINED_DROP_ARTHUR_TASTYCUPCAKE_HUT_1)
		...
		(NOT_EXPLAINED_DROP_ARTHUR_TASTYCUPCAKE_HUT_1)
	...
	(:action EXPLAIN_OBS_DROP_ARTHUR_TASTYCUPCAKE_HUT_1
		:parameters ()
		:precondition
		(and
			(WILLING-TO-GIVE-ITEM_ARTHUR_TASTYCUPCAKE)
		...
		(and
			...
			(not (WILLING-TO-GIVE-ITEM_ARTHUR_TASTYCUPCAKE))
			 (not (NOT_EXPLAINED_DROP_ARTHUR_TASTYCUPCAKE_HUT_1))
		)
	)
