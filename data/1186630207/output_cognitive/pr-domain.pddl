(define
	...
	(:predicates
		...
		(EXPLAINED_DROP_ARTHUR_TASTYCUPCAKE_TOWNARCH_1)
		(EXPLAINED_DROP_ARTHUR_BOOK_TOWNARCH_1)
		(EXPLAINED_DROP_ARTHUR_TASTYCUPCAKE_TOWNARCH_2)
		...
		(EXPLAINED_DROP_ARTHUR_ROPE_TOWNARCH_1)
		...
		(NOT_EXPLAINED_DROP_ARTHUR_ROPE_TOWNARCH_1)
	...
	(:action EXPLAIN_OBS_DROP_ARTHUR_TASTYCUPCAKE_TOWNARCH_1
		:parameters ()
		:precondition
		(and
			(WILLING-TO-GIVE-ITEM_ARTHUR_TASTYCUPCAKE)
		...
		(and
			...
			(not (WILLING-TO-GIVE-ITEM_ARTHUR_TASTYCUPCAKE))
			 (not (NOT_EXPLAINED_DROP_ARTHUR_TASTYCUPCAKE_TOWNARCH_1))
		)
	)
	...
	(:action EXPLAIN_OBS_DROP_ARTHUR_TASTYCUPCAKE_TOWNARCH_2
		:parameters ()
		:precondition
		(and
			(WILLING-TO-GIVE-ITEM_ARTHUR_TASTYCUPCAKE)
		...
		(and
			...
			(not (NOT-AT_TASTYCUPCAKE_TOWNARCH))
			(not (WILLING-TO-GIVE-ITEM_ARTHUR_TASTYCUPCAKE))
			 (not (NOT_EXPLAINED_DROP_ARTHUR_TASTYCUPCAKE_TOWNARCH_2))
		)
	)
	(:action DROP_ARTHUR_TASTYCUPCAKE_TOWNARCH
		:parameters ()
	...
	(:action EXPLAIN_OBS_DROP_ARTHUR_ROPE_TOWNARCH_1
		:parameters ()
		:precondition
		(and
			(WILLING-TO-GIVE-ITEM_ARTHUR_ROPE)
		...
		(and
			...
			(not (WILLING-TO-GIVE-ITEM_ARTHUR_ROPE))
			 (not (NOT_EXPLAINED_DROP_ARTHUR_ROPE_TOWNARCH_1))
		)
	)
