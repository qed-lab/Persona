(define
	...
	(:predicates
		...
		(EXPLAINED_DROP_ARTHUR_LOVELETTER_TOWNSQUARE_1)
		...
		(NOT_EXPLAINED_DROP_ARTHUR_LOVELETTER_TOWNSQUARE_1)
	...
	(:action EXPLAIN_OBS_DROP_ARTHUR_LOVELETTER_TOWNSQUARE_1
		:parameters ()
		:precondition
		(and
			(WILLING-TO-GIVE-ITEM_ARTHUR_LOVELETTER)
		...
		(and
			...
			(not (WILLING-TO-GIVE-ITEM_ARTHUR_LOVELETTER))
			 (not (NOT_EXPLAINED_DROP_ARTHUR_LOVELETTER_TOWNSQUARE_1))
		)
	)
