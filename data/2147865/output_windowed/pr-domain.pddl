(define
	...
	(:predicates
		...
		(GOAL-REACHED)
		(EXPLAINED_DROP_ARTHUR_MIRROR_MANSION_1)
		...
		(NOT_EXPLAINED_DROP_ARTHUR_MIRROR_MANSION_1)
	...
	(:action EXPLAIN_OBS_DROP_ARTHUR_MIRROR_MANSION_1
		:parameters ()
		:precondition
		(and
			(WILLING-TO-GIVE-ITEM_ARTHUR_MIRROR)
		...
		(and
			...
			(not (WILLING-TO-GIVE-ITEM_ARTHUR_MIRROR))
			 (not (NOT_EXPLAINED_DROP_ARTHUR_MIRROR_MANSION_1))
		)
	)
