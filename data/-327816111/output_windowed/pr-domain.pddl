(define
	...
	(:predicates
		...
		(EXPLAINED_PICKUP_ARTHUR_BOUQUET_TOWNSQUARE_1)
		...
		(NOT_EXPLAINED_PICKUP_ARTHUR_BOUQUET_TOWNSQUARE_1)
	...
	(:action EXPLAIN_OBS_PICKUP_ARTHUR_BOUQUET_TOWNSQUARE_1
		:parameters ()
		:precondition
		(and
			(AT_BOUQUET_TOWNSQUARE)
		...
		(and
			...
			(not (NOT-HAS_ARTHUR_BOUQUET))
			 (not (NOT_EXPLAINED_PICKUP_ARTHUR_BOUQUET_TOWNSQUARE_1))
