(define
	...
	(:predicates
		...
		(EXPLAINED_PICKUP_ARTHUR_KNIGHTSHIELD_CLIFF_1)
		...
		(NOT_EXPLAINED_PICKUP_ARTHUR_KNIGHTSHIELD_CLIFF_1)
	...
	(:action EXPLAIN_OBS_PICKUP_ARTHUR_KNIGHTSHIELD_CLIFF_1
		:parameters ()
		:precondition
		(and
			(AT_KNIGHTSHIELD_CLIFF)
		...
		(and
			...
			(not (NOT-HAS_ARTHUR_KNIGHTSHIELD))
			 (not (NOT_EXPLAINED_PICKUP_ARTHUR_KNIGHTSHIELD_CLIFF_1))
		)
	)
