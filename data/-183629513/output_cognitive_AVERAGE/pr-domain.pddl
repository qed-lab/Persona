(define
	...
	(:predicates
		...
		(EXPLAINED_OPEN_ARTHUR_BARENTRANCE_DOCKS_1)
		...
		(EXPLAINED_CLOSE_ARTHUR_BARENTRANCE_DOCKS_2)
		...
		(EXPLAINED_OPEN_ARTHUR_BARENTRANCE_DOCKS_2)
		...
		(NOT_EXPLAINED_OPEN_ARTHUR_BARENTRANCE_DOCKS_2)
	...
	(:action EXPLAIN_OBS_OPEN_ARTHUR_BARENTRANCE_DOCKS_1
		:parameters ()
		:precondition
		(and
			(CLOSED_BARENTRANCE)
		...
		(and
			...
			(NOT-CLOSED_BARENTRANCE)
			 (EXPLAINED_OPEN_ARTHUR_BARENTRANCE_DOCKS_1)
			(not (CLOSED_BARENTRANCE))
			 (not (NOT_EXPLAINED_OPEN_ARTHUR_BARENTRANCE_DOCKS_1))
		)
	)
	...
	(:action EXPLAIN_OBS_CLOSE_ARTHUR_BARENTRANCE_DOCKS_2
		:parameters ()
		:precondition
		(and
			(NOT-CLOSED_BARENTRANCE)
		...
		(and
			...
			(CLOSED_BARENTRANCE)
			 (EXPLAINED_CLOSE_ARTHUR_BARENTRANCE_DOCKS_2)
			(not (NOT-CLOSED_BARENTRANCE))
			 (not (NOT_EXPLAINED_CLOSE_ARTHUR_BARENTRANCE_DOCKS_2))
		)
	)
	(:action CLOSE_ARTHUR_BARENTRANCE_DOCKS
		:parameters ()
	...
	(:action EXPLAIN_OBS_OPEN_ARTHUR_BARENTRANCE_DOCKS_2
		:parameters ()
		:precondition
		(and
			(CLOSED_BARENTRANCE)
		...
		(and
			...
			(NOT-CLOSED_BARENTRANCE)
			 (EXPLAINED_OPEN_ARTHUR_BARENTRANCE_DOCKS_2)
			(not (CLOSED_BARENTRANCE))
			 (not (NOT_EXPLAINED_OPEN_ARTHUR_BARENTRANCE_DOCKS_2))
		)
	)
	(:action OPEN_ARTHUR_BARENTRANCE_DOCKS
		:parameters ()
