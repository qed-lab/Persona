(define
	...
	(:predicates
		...
		(EXPLAINED_PICKUP_ARTHUR_HAIRTONIC_TOWNSQUARE_1)
		...
		(NOT_EXPLAINED_PICKUP_ARTHUR_HAIRTONIC_TOWNSQUARE_1)
	...
	(:action EXPLAIN_OBS_PICKUP_ARTHUR_HAIRTONIC_TOWNSQUARE_1
		:parameters ()
		:precondition
		(and
			(AT_HAIRTONIC_TOWNSQUARE)
		...
		(and
			...
			(not (AT_HAIRTONIC_TOWNSQUARE))
			(not (NOT-HAS_ARTHUR_HAIRTONIC))
			 (not (NOT_EXPLAINED_PICKUP_ARTHUR_HAIRTONIC_TOWNSQUARE_1))
		)
	)
