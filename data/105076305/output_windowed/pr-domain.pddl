(define
	...
	(:predicates
		...
		(EXPLAINED_DROP_ARTHUR_ROPE_CLIFF_1)
		...
		(NOT_EXPLAINED_DROP_ARTHUR_ROPE_CLIFF_1)
	...
	(:action EXPLAIN_OBS_DROP_ARTHUR_ROPE_CLIFF_1
		:parameters ()
		:precondition
		(and
			(WILLING-TO-GIVE-ITEM_ARTHUR_ROPE)
		...
		(and
			...
			(not (WILLING-TO-GIVE-ITEM_ARTHUR_ROPE))
			 (not (NOT_EXPLAINED_DROP_ARTHUR_ROPE_CLIFF_1))
		)
	)
