(define
	...
	(:predicates
		...
		(EXPLAINED_DROP_ARTHUR_ASH_TOWNARCH_1)
		...
		(EXPLAINED_DROP_ARTHUR_HAIRTONIC_TOWNSQUARE_1)
	...
	(:action EXPLAIN_OBS_DROP_ARTHUR_ASH_TOWNARCH_1
		:parameters ()
		:precondition
		(and
			(WILLING-TO-GIVE-ITEM_ARTHUR_ASH)
		...
		(and
			...
			(not (WILLING-TO-GIVE-ITEM_ARTHUR_ASH))
			 (not (NOT_EXPLAINED_DROP_ARTHUR_ASH_TOWNARCH_1))
		)
	)
	...
	(:action EXPLAIN_OBS_DROP_ARTHUR_HAIRTONIC_TOWNSQUARE_1
		:parameters ()
		:precondition
		(and
			(WILLING-TO-GIVE-ITEM_ARTHUR_HAIRTONIC)
		...
		(and
			...
			(not (WILLING-TO-GIVE-ITEM_ARTHUR_HAIRTONIC))
			 (not (NOT_EXPLAINED_DROP_ARTHUR_HAIRTONIC_TOWNSQUARE_1))
