(define
	...
	(:predicates
		...
		(EXPLAINED_PICKUP_ARTHUR_HAIRTONIC_CLIFF_1)
		...
		(NOT_EXPLAINED_PICKUP_ARTHUR_HAIRTONIC_CLIFF_1)
	...
	(:action EXPLAIN_OBS_PICKUP_ARTHUR_HAIRTONIC_CLIFF_1
		:parameters ()
		:precondition
		(and
			(AT_HAIRTONIC_CLIFF)
		...
		(and
			...
			(not (AT_HAIRTONIC_CLIFF))
			(not (NOT-HAS_ARTHUR_HAIRTONIC))
			 (not (NOT_EXPLAINED_PICKUP_ARTHUR_HAIRTONIC_CLIFF_1))
		)
	)
