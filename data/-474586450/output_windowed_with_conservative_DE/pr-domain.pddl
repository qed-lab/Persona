(define
	...
	(:predicates
		...
		(EXPLAINED_DROP_ARTHUR_BOUQUET_FORT_1)
		...
		(NOT_EXPLAINED_DROP_ARTHUR_BOUQUET_FORT_1)
	...
	(:action EXPLAIN_OBS_DROP_ARTHUR_BOUQUET_FORT_1
		:parameters ()
		:precondition
		(and
			(WILLING-TO-GIVE-ITEM_ARTHUR_BOUQUET)
		...
		(and
			...
			(not (WILLING-TO-GIVE-ITEM_ARTHUR_BOUQUET))
			 (not (NOT_EXPLAINED_DROP_ARTHUR_BOUQUET_FORT_1))
