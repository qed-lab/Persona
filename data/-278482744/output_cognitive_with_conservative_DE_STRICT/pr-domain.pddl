(define
	...
	(:predicates
		...
		(EXPLAINED_DROP_ARTHUR_SHINYKEY_SHOP_1)
		...
		(NOT_EXPLAINED_DROP_ARTHUR_SHINYKEY_SHOP_1)
	...
	(:action EXPLAIN_OBS_DROP_ARTHUR_SHINYKEY_SHOP_1
		:parameters ()
		:precondition
		(and
			(WILLING-TO-GIVE-ITEM_ARTHUR_SHINYKEY)
		...
		(and
			...
			(not (WILLING-TO-GIVE-ITEM_ARTHUR_SHINYKEY))
			 (not (NOT_EXPLAINED_DROP_ARTHUR_SHINYKEY_SHOP_1))
		)
	)
