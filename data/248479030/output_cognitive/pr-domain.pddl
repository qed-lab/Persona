(define
	...
	(:predicates
		...
		(EXPLAINED_DROP_ARTHUR_SHINYKEY_DOCKS_1)
		(EXPLAINED_PICKUP_ARTHUR_MIRROR_DOCKS_1)
		(EXPLAINED_DROP_ARTHUR_MUSHROOM_DOCKS_1)
		(EXPLAINED_DROP_ARTHUR_MIRROR_DOCKS_1)
		(EXPLAINED_PICKUP_ARTHUR_SHINYKEY_DOCKS_1)
		...
		(NOT_EXPLAINED_DROP_ARTHUR_SHINYKEY_DOCKS_1)
		(NOT_EXPLAINED_PICKUP_ARTHUR_MIRROR_DOCKS_1)
		(NOT_EXPLAINED_DROP_ARTHUR_MUSHROOM_DOCKS_1)
		(NOT_EXPLAINED_DROP_ARTHUR_MIRROR_DOCKS_1)
		(NOT_EXPLAINED_PICKUP_ARTHUR_SHINYKEY_DOCKS_1)
	...
	(:action EXPLAIN_OBS_DROP_ARTHUR_SHINYKEY_DOCKS_1
		:parameters ()
		:precondition
		(and
			(WILLING-TO-GIVE-ITEM_ARTHUR_SHINYKEY)
		...
		(and
			...
			(not (WILLING-TO-GIVE-ITEM_ARTHUR_SHINYKEY))
			 (not (NOT_EXPLAINED_DROP_ARTHUR_SHINYKEY_DOCKS_1))
		)
	)
	...
	(:action EXPLAIN_OBS_PICKUP_ARTHUR_MIRROR_DOCKS_1
		:parameters ()
		:precondition
		(and
			(AT_MIRROR_DOCKS)
		...
		(and
			...
			(not (AT_MIRROR_DOCKS))
			(not (NOT-HAS_ARTHUR_MIRROR))
			 (not (NOT_EXPLAINED_PICKUP_ARTHUR_MIRROR_DOCKS_1))
		)
	)
	...
	(:action EXPLAIN_OBS_PICKUP_ARTHUR_SHINYKEY_DOCKS_1
		:parameters ()
		:precondition
		(and
			(AT_SHINYKEY_DOCKS)
		...
		(and
			...
			(not (AT_SHINYKEY_DOCKS))
			(not (NOT-HAS_ARTHUR_SHINYKEY))
			 (not (NOT_EXPLAINED_PICKUP_ARTHUR_SHINYKEY_DOCKS_1))
		)
	)
