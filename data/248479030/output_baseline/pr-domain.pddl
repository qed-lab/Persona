(define
	...
	(:predicates
		...
		(EXPLAINED_DROP_ARTHUR_MIRROR_DOCKS_2)
		...
		(NOT_EXPLAINED_DROP_ARTHUR_MIRROR_DOCKS_2)
	...
	(:action EXPLAIN_OBS_DROP_ARTHUR_MIRROR_DOCKS_2
		:parameters ()
		:precondition
		(and
			(WILLING-TO-GIVE-ITEM_ARTHUR_MIRROR)
		...
		(and
			...
			(not (NOT-AT_MIRROR_DOCKS))
			(not (WILLING-TO-GIVE-ITEM_ARTHUR_MIRROR))
			 (not (NOT_EXPLAINED_DROP_ARTHUR_MIRROR_DOCKS_2))
		)
	)
	(:action DROP_ARTHUR_MIRROR_DOCKS
		:parameters ()
