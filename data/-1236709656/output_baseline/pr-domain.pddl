(define
	...
	(:predicates
		...
		(EXPLAINED_DROP_ARTHUR_MIRROR_DOCKS_1)
		...
		(EXPLAINED_DROP_ARTHUR_MUSHROOM_DOCKS_1)
		...
		(NOT_EXPLAINED_DROP_ARTHUR_MIRROR_DOCKS_1)
	...
	(:action EXPLAIN_OBS_DROP_ARTHUR_MIRROR_DOCKS_1
		:parameters ()
		:precondition
		(and
			(WILLING-TO-GIVE-ITEM_ARTHUR_MIRROR)
		...
		(and
			...
			(not (WILLING-TO-GIVE-ITEM_ARTHUR_MIRROR))
			 (not (NOT_EXPLAINED_DROP_ARTHUR_MIRROR_DOCKS_1))
		)
	)
	...
	(:action EXPLAIN_OBS_DROP_ARTHUR_MUSHROOM_DOCKS_1
		:parameters ()
		:precondition
		(and
			(WILLING-TO-GIVE-ITEM_ARTHUR_MUSHROOM)
		...
		(and
			...
			(not (WILLING-TO-GIVE-ITEM_ARTHUR_MUSHROOM))
			 (not (NOT_EXPLAINED_DROP_ARTHUR_MUSHROOM_DOCKS_1))
		)
	)
