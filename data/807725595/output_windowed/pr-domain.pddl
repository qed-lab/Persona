(define
	...
	(:predicates
		...
		(GOAL-REACHED)
		(EXPLAINED_DROP_ARTHUR_LOVELETTER_FORT_1)
		(EXPLAINED_DROP_ARTHUR_MIRROR_FORT_1)
		...
		(NOT_EXPLAINED_DROP_ARTHUR_LOVELETTER_FORT_1)
		(NOT_EXPLAINED_DROP_ARTHUR_MIRROR_FORT_1)
	...
	(:action EXPLAIN_OBS_DROP_ARTHUR_LOVELETTER_FORT_1
		:parameters ()
		:precondition
		(and
			(WILLING-TO-GIVE-ITEM_ARTHUR_LOVELETTER)
		...
		(and
			...
			(not (WILLING-TO-GIVE-ITEM_ARTHUR_LOVELETTER))
			 (not (NOT_EXPLAINED_DROP_ARTHUR_LOVELETTER_FORT_1))
		)
	)
	(:action EXPLAIN_OBS_DROP_ARTHUR_MIRROR_FORT_1
		:parameters ()
		:precondition
		(and
			(WILLING-TO-GIVE-ITEM_ARTHUR_MIRROR)
		...
		(and
			...
			(not (WILLING-TO-GIVE-ITEM_ARTHUR_MIRROR))
			 (not (NOT_EXPLAINED_DROP_ARTHUR_MIRROR_FORT_1))
		)
	)
