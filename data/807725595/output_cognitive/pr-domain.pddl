(define
	...
	(:predicates
		...
		(EXPLAINED_PICKUP_ARTHUR_RUBYRING_TOWNSQUARE_1)
		...
		(NOT_EXPLAINED_PICKUP_ARTHUR_RUBYRING_TOWNSQUARE_1)
	...
	(:action EXPLAIN_OBS_PICKUP_ARTHUR_RUBYRING_TOWNSQUARE_1
		:parameters ()
		:precondition
		(and
			(AT_RUBYRING_TOWNSQUARE)
		...
		(and
			...
			(not (AT_RUBYRING_TOWNSQUARE))
			(not (NOT-HAS_ARTHUR_RUBYRING))
			 (not (NOT_EXPLAINED_PICKUP_ARTHUR_RUBYRING_TOWNSQUARE_1))
		)
	)
