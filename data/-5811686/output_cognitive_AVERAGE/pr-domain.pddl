(define
	...
	(:predicates
		...
		(EXPLAINED_MOVE-THROUGH-DOORWAY_ARTHUR_DOCKS_JUNKYARD_4)
		...
		(NOT_EXPLAINED_MOVE-THROUGH-DOORWAY_ARTHUR_DOCKS_JUNKYARD_4)
	...
	(:action EXPLAIN_OBS_MOVE-THROUGH-DOORWAY_ARTHUR_DOCKS_JUNKYARD_4
		:parameters ()
		:precondition
		(and
			(NOT-AT_ARTHUR_JUNKYARD)
		...
		(and
			...
			(not (AT_ARTHUR_DOCKS))
			(not (NOT-AT_ARTHUR_JUNKYARD))
			 (not (NOT_EXPLAINED_MOVE-THROUGH-DOORWAY_ARTHUR_DOCKS_JUNKYARD_4))
		)
	)
	(:action MOVE-THROUGH-DOORWAY_ARTHUR_DOCKS_JUNKYARD
		:parameters ()
