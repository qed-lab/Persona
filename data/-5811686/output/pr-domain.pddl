(define
	...
	(:predicates
		...
		(GOAL-REACHED)
		(EXPLAINED_PICKUP_ARTHUR_BASEMENTBUCKET_STORAGE_1)
		(NOT_EXPLAINED_PICKUP_ARTHUR_BASEMENTBUCKET_STORAGE_1)
		(EXPLAINED_FULL_OBS_SEQUENCE)
		(NOT_EXPLAINED_FULL_OBS_SEQUENCE)
	) 
	(:functions (total-cost))
	(:action EXPLAIN_OBS_PICKUP_ARTHUR_BASEMENTBUCKET_STORAGE_1
		:parameters ()
		:precondition
		(and
			(AT_BASEMENTBUCKET_STORAGE)
		...
		(and
			...
			(not (NOT-HAS_ARTHUR_BASEMENTBUCKET))
			 (not (NOT_EXPLAINED_PICKUP_ARTHUR_BASEMENTBUCKET_STORAGE_1))
