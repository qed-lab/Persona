(define
	...
	(:predicates
		...
		(EXPLAINED_DROP_ARTHUR_KNIGHTSWORD_TOWNARCH_1)
		...
		(EXPLAINED_PICKUP_ARTHUR_TASTYCUPCAKE_TOWNARCH_1)
	...
	(:action EXPLAIN_OBS_DROP_ARTHUR_KNIGHTSWORD_TOWNARCH_1
		:parameters ()
		:precondition
		(and
			(WILLING-TO-GIVE-ITEM_ARTHUR_KNIGHTSWORD)
		...
		(and
			...
			(not (WILLING-TO-GIVE-ITEM_ARTHUR_KNIGHTSWORD))
			 (not (NOT_EXPLAINED_DROP_ARTHUR_KNIGHTSWORD_TOWNARCH_1))
		)
	)
	...
	(:action EXPLAIN_OBS_PICKUP_ARTHUR_TASTYCUPCAKE_TOWNARCH_1
		:parameters ()
		:precondition
		(and
			(AT_TASTYCUPCAKE_TOWNARCH)
		...
		(and
			...
			(not (AT_TASTYCUPCAKE_TOWNARCH))
			(not (NOT-HAS_ARTHUR_TASTYCUPCAKE))
			 (not (NOT_EXPLAINED_PICKUP_ARTHUR_TASTYCUPCAKE_TOWNARCH_1))
		)
	)
