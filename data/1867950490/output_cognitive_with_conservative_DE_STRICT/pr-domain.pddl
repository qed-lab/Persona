(define
	...
	(:predicates
		...
		(EXPLAINED_DROP_ARTHUR_ASH_TOWNSQUARE_1)
		...
		(EXPLAINED_DROP_ARTHUR_SILVER_TOWNSQUARE_2)
		...
		(NOT_EXPLAINED_DROP_ARTHUR_ASH_TOWNSQUARE_1)
		...
		(NOT_EXPLAINED_DROP_ARTHUR_SILVER_TOWNSQUARE_2)
	...
	(:action EXPLAIN_OBS_DROP_ARTHUR_ASH_TOWNSQUARE_1
		:parameters ()
		:precondition
		(and
			(WILLING-TO-GIVE-ITEM_ARTHUR_ASH)
		...
		(and
			...
			(not (WILLING-TO-GIVE-ITEM_ARTHUR_ASH))
			 (not (NOT_EXPLAINED_DROP_ARTHUR_ASH_TOWNSQUARE_1))
		)
	)
	...
	(:action EXPLAIN_OBS_DROP_ARTHUR_SILVER_TOWNSQUARE_2
		:parameters ()
		:precondition
		(and
			(WILLING-TO-GIVE-ITEM_ARTHUR_SILVER)
		...
		(and
			...
			(not (NOT-AT_SILVER_TOWNSQUARE))
			(not (WILLING-TO-GIVE-ITEM_ARTHUR_SILVER))
			 (not (NOT_EXPLAINED_DROP_ARTHUR_SILVER_TOWNSQUARE_2))
		)
	)
	(:action DROP_ARTHUR_SILVER_TOWNSQUARE
		:parameters ()
