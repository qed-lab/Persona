(define
	...
	(:predicates
		...
		(GOAL-REACHED)
		(EXPLAINED_DROP_ARTHUR_KNIGHTSHIELD_VALLEY_1)
		(EXPLAINED_DROP_ARTHUR_KNIGHTSWORD_VALLEY_1)
		...
		(NOT_EXPLAINED_DROP_ARTHUR_KNIGHTSHIELD_VALLEY_1)
		(NOT_EXPLAINED_DROP_ARTHUR_KNIGHTSWORD_VALLEY_1)
	...
	(:action EXPLAIN_OBS_DROP_ARTHUR_KNIGHTSHIELD_VALLEY_1
		:parameters ()
		:precondition
		(and
			(WILLING-TO-GIVE-ITEM_ARTHUR_KNIGHTSHIELD)
		...
		(and
			...
			(not (WILLING-TO-GIVE-ITEM_ARTHUR_KNIGHTSHIELD))
			 (not (NOT_EXPLAINED_DROP_ARTHUR_KNIGHTSHIELD_VALLEY_1))
		)
	)
	(:action EXPLAIN_OBS_DROP_ARTHUR_KNIGHTSWORD_VALLEY_1
		:parameters ()
		:precondition
		(and
			(WILLING-TO-GIVE-ITEM_ARTHUR_KNIGHTSWORD)
		...
		(and
			...
			(not (WILLING-TO-GIVE-ITEM_ARTHUR_KNIGHTSWORD))
			 (not (NOT_EXPLAINED_DROP_ARTHUR_KNIGHTSWORD_VALLEY_1))
		)
	)
