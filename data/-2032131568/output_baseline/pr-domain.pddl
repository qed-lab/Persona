(define
	...
	(:predicates
		...
		(EXPLAINED_MOVE-THROUGH-DOORWAY_ARTHUR_BASEMENT_STORAGE_2)
		(NOT_EXPLAINED_MOVE-THROUGH-DOORWAY_ARTHUR_BASEMENT_STORAGE_1)
		(NOT_EXPLAINED_MOVE-THROUGH-DOORWAY_ARTHUR_BASEMENT_STORAGE_2)
	...
	(:action EXPLAIN_OBS_MOVE-THROUGH-DOORWAY_ARTHUR_BASEMENT_STORAGE_2
		:parameters ()
		:precondition
		(and
			(NOT-AT_ARTHUR_STORAGE)
		...
		(and
			...
			(not (AT_ARTHUR_BASEMENT))
			(not (NOT-AT_ARTHUR_STORAGE))
			 (not (NOT_EXPLAINED_MOVE-THROUGH-DOORWAY_ARTHUR_BASEMENT_STORAGE_2))
